...
exports.seed = async (knex) => {
  ...
  await knex(tableNames.vendor).insert({
    name: 'Bush Brothers & vendor',
    logo_url: 'https://i.imgur.com/KRKQ7LZ.jpg',
    description:
      "Bush Brothers and vendor is a family-owned corporation best known for its Bush's Best brand canned baked beans.",
    website_url: 'https://bushbeans.com/',
    email: 'help@bushbros.com',
    address_id,
  });

  await knex(tableNames.product_type).insert({
    name: 'Canned Goods',
  });
